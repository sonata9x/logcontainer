...
추가 UI 조정으로 CSS 블록에 6px 바깥 여백을 먼저 추가했으며, 후속 [로그 간격 통일](./log-spacing-20260918.md)에서 메시지 공통 12px·동일 화자의 일반 대화 4px 규칙으로 대체했다. 사용자 CSS padding/top/bottom, 중앙 정렬, canonical document는 변경하지 않는다.
